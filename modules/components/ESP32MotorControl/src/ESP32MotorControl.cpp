...
void ESP32MotorControl::PwmWrite(ledc_channel_t channel, int pwm) {
  ledc_set_duty_and_update(LEDC_MODE, channel, pwm,
...
void ESP32MotorControl::attachMotors(uint8_t _gpioAIN1, uint8_t _gpioAIN2,
  ...
  io_conf.pin_bit_mask = ((1ULL << gpioAIN1) | (1ULL << gpioAIN2) | (1ULL <<
  gpioBIN1) | (1ULL << gpioBIN2)); io_conf.pull_down_en = GPIO_PULLDOWN_DISABLE;
